...
| ModelDial reset / archive 404 / hash mismatch | Separate installation and data selection. Use only a qualified cache or coordinator ownership; never join unrelated batches. |
...
- **Runtime verified:** the actual host loads GPT-6 roles, both families perform useful work, and the coordinator reviews results.
