...
| --- | --- | --- |
| v4.3.1 | Current Stable, GPT-6 / 当前正式版 | [Release](https://github.com/SuperDaddyV/codex-native-workers/releases/tag/v4.3.1) · [Instructions](NATIVE_WORKERS_SETUP.md) · [Evidence](https://github.com/SuperDaddyV/codex-native-workers/releases/download/v4.3.1/native-workers-v4.3.1-validation.json) |
| v4.3.0 | Previous Stable, GPT-6 / 旧正式版 | [Release](https://github.com/SuperDaddyV/codex-native-workers/releases/tag/v4.3.0) · [Instructions](https://github.com/SuperDaddyV/codex-native-workers/blob/v4.3.0/NATIVE_WORKERS_SETUP.md) · [Evidence](https://github.com/SuperDaddyV/codex-native-workers/releases/download/v4.3.0/native-workers-v4.3.0-validation.json) |
