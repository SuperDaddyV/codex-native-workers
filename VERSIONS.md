...
| --- | --- | --- |
| v4.3.0 | GPT-6 candidate; unpublished / 候选未发布 | [Candidate branch](https://github.com/SuperDaddyV/codex-native-workers/tree/codex/gpt6-v4.3.0) |
| v4.2.0 | Current published Stable / 当前正式版，GPT-5.6 | [Release](https://github.com/SuperDaddyV/codex-native-workers/releases/tag/v4.2.0) · [Instructions](https://github.com/SuperDaddyV/codex-native-workers/blob/v4.2.0/NATIVE_WORKERS_SETUP.md) · [Evidence](https://github.com/SuperDaddyV/codex-native-workers/releases/download/v4.2.0/native-workers-v4.2.0-validation.json) |
