...
class ResultCardTests(unittest.TestCase):
    ...
    def test_reload_and_selector_initialization_cards_are_actionable(self):
        ...
        self.assertIn("installed delegation Skill routing contract", selector_card)
        self.assertIn("host-role checks", selector_card)
        self.assertIn("basic-mode disclosure", selector_card)
